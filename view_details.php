...
$sql = "SELECT user_id,last_name,first_name,username,password,email,role  FROM users WHERE email = ?";
...
<div class="container-fluid sticky-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
            ...
            <div class="navbar-nav">
                ...
                <div class="ms-auto d-none d-lg-flex">
                    <a class="btn btn-lg-square btn-primary me-2" href="https://www.instagram.com/@niyonshuti jean p"><i class="fab fa-instagram"></i></a>
    ...
    <h1>User Details</h1>
    <p><strong>User_id        :    </strong> <?php echo $userData["user_id"]; ?></p>
    <p><strong>Last_name         :    </strong> <?php echo $userData["last_name"]; ?></p>
    <p><strong>First_name  :    </strong> <?php echo $userData["first_name"]; ?></p>
        ...
        <div class="container">
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <p class="fs-5 mb-4">Have a question or need assistance? Reach out to us anytime, day or night. Our friendly team is standing by to provide prompt and professional support for all your AR service needs. Get in touch with us now!</p>
                    ...
                    <div class="d-flex mt-4">
                        <a class="btn btn-square btn-light mx-1" href="https://www.instagram.com/@niyonshuti jean p"><i class="fab fa-instagram"></i></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-0">&copy; <a href="about.html">AR Platiform (AR Booking System Platiform)</a>. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a href="https://www.instagram.com/@niyonshuti jean p">Jean Pierre NIYONSHUTI</a></p>
                </div>
            </div>
        </div>
    </div>
